...
# install.packages("CNPDIA_1.5.tar.gz", repos = NULL, type = "tar.gz")
# install.packages("CNPDIA_1.5.tar.gz", repos = CRAN, type = "tar.gz")
...
The output of `perturbRange()` is a dataframe (str(outputname)) of which the named output can be manipulated with standard plotting procedures, such as `boxplot()` or `plot()`.
